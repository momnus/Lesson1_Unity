...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private AudioClip m_LandSound = null;           // the sound played when character touches back on ground.
                                                                         //  [SerializeField] private AK.Wwise.Event JumpSound = null;           // the sound played when character leaves the ground.
                                                                         //  [SerializeField] private AK.Wwise.Event LandSound = null;           // the sound played when character touches back on ground.
                                                                         //  [SerializeField] private AK.Wwise.Event FootstepSounds = null;    // footstep sounds 
        [SerializeField] private LayerMask lm;  // Layer Mask
        ...
        private void SurfaceSwitch()

        { if (Physics.Raycast(transform.position, Vector3.down, out RaycastHit hit, r, lm)) // запускаем рейкаст из объекта нужной ноги вниз
            {
        ...
        private void PlayLandingSound()
        {
            ...
            // LandSound.Post(gameObject);              // WWise land sound
        ...
        private void PlayJumpSound()
        {
            ...
            m_AudioSource.Play();
            // JumpSound.Post(gameObject);              // WWise jump sound
        }
        ...
        private void PlayFootStepAudio()
        {
            ...
            // FootstepSound.Post(gameObject);              // WWise land sound
